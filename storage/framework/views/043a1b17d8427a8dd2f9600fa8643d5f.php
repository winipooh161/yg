        ...
        <div class="tabs-blocks-pop">
            ...
            <div class="tabs__blocks-page one-tabs__blocks-page  wow fadeInRight" data-wow-duration="2s" data-wow-delay="2s">
                <div class="tabs__blocks-page-title">
                    ...
                    <div class="section-body-page__buttons">
                        <button class="blick" onclick="openQuizModal()">Пригласить прораба <img src="<?php echo e(asset('img/icon/comment.svg ')); ?>"
                                alt=""></button>
                    </div>
                </div>
            </div>
            <div class="tabs__blocks-page two-tabs__blocks-page">
                <div class="tabs__blocks-page-title">
                    ...
                    <div class="section-body-page__buttons">
                        <button class="blick" >Узнать стоимость дизайн-проекта <img src="<?php echo e(asset('img/icon/comment.svg ')); ?>"
                                alt=""></button>
                    </div>
                </div>
            </div>
            ...
            <div class="tabs__blocks-page four-tabs__blocks-page">
                <div class="tabs__blocks-page-title">
                    ...
                    <div class="section-body-page__buttons">
                        <button class="blick"onclick="openQuizModal()" >Обратиться к нам <img src="<?php echo e(asset('img/icon/comment.svg ')); ?>"
                                alt=""></button>
                    </div>
                </div>
            </div>
            <div class="tabs__blocks-page five-tabs__blocks-page">
                <div class="tabs__blocks-page-title">
                    ...
                    <div class="section-body-page__buttons">
                        <button class="blick"onclick="openQuizModal()" >Оставить заявку прямо сейчас <img src="<?php echo e(asset('img/icon/comment.svg ')); ?>"
                                alt=""></button>
                    </div>
                </div>
            </div>
...
<?php /**PATH C:\OSPanel\domains\yg\resources\views/home/tabs.blade.php ENDPATH**/ ?>