        ...
        <div class="form-send form-send-five">
            ...
            <form action="<?php echo e(route('telegram.store')); ?>" method="POST" class="wow fadeInLeft" data-wow-duration="1.2s" data-wow-delay="1.2s">
                ...
                <div class="section-body-page__buttons">
                    <button class="blick" >Получить смету на работы <img src="<?php echo e(asset('img/icon/send-write.svg ')); ?>" alt=""></button>
                </div>
            </form>
            <div class="form-person-five  wow fadeInRight" data-wow-duration="0.5s" data-wow-delay="0.5s">
                <div class="abs-elements page-abs-elements-12">
                    <img class="animCurdor" src="<?php echo e(asset('img/elements/calc.png ')); ?>" alt="">
                 </div>
                    <img class="animCurdor" src="<?php echo e(asset('img/form-five-personal.png')); ?>" alt="">
            </div>
        </div>
    </div>
</section>
<?php /**PATH C:\OSPanel\domains\yg\resources\views\form\form-five.blade.php ENDPATH**/ ?>