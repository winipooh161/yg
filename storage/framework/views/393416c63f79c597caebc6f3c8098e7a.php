<section class="form" id="form">
    <div class="container">
        <div class="form-send form-send-two">
            ...
            <form action="<?php echo e(route('telegram.store')); ?>" method="POST" class="wow fadeInLeft" data-wow-duration="1.2s" data-wow-delay="1.2s">
                <?php echo csrf_field(); ?>
                ...
                <div class="section-body-page__buttons">
                    <button class="blick">Отправить заявку <img src="<?php echo e(asset('img/icon/send-write.svg ')); ?>"
                            alt=""></button>
                </div>
            </form>
            <div class="form-person-two  wow fadeInRight" data-wow-duration="0.5s" data-wow-delay="0.5s">
                <img class="animCurdor" src="<?php echo e(asset('img/form-two-personal.png ')); ?>" alt="">
                <div class="abs-elements page-abs-elements-five">
                    <img class="animCurdor" src="<?php echo e(asset('img/elements/tools-art-repairing-paint-space-text.png ')); ?>"
                        alt="">
                </div>
                <div class="abs-elements page-abs-elements-six">
                    <img class="animCurdor" src="<?php echo e(asset('img/elements/list2.png ')); ?>" alt="">
                </div>
            </div>
        </div>
    </div>
</section>
<?php /**PATH C:\OSPanel\domains\yg\resources\views/form/form-two.blade.php ENDPATH**/ ?>