       ...
       <div class="form-send">
            ...
            <form action="<?php echo e(route('telegram.store')); ?>" method="POST" class=" wow fadeInLeft" data-wow-duration="1.2s" data-wow-delay="1.2s">
                ...
                <div class="section-body-page__buttons">
                    <button class="blick" >Отправить заявку <img src="<?php echo e(asset('img/icon/send-write.svg ')); ?>" alt=""></button>
                </div>
            </form>
            <div class="form-person  ">
                <div class="abs-elements page-abs-elements-one">
                    <img class="animCurdor" src="<?php echo e(asset('img/elements/caler.png ')); ?>" alt="">
                 </div>
                 <div class="abs-elements page-abs-elements-tree">
                    <img class="animCurdor" src="<?php echo e(asset('img/elements/list1.png ')); ?>" alt="">
                 </div>
                <img class="animCurdor"src="<?php echo e(asset('img/form-one-personal.png ')); ?>" alt="">
               </div>
       </div>
    </div>
</section><?php /**PATH C:\OSPanel\domains\yg\resources\views\form\form-one.blade.php ENDPATH**/ ?>