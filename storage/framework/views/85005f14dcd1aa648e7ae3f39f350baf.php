            ...
            <div class="admin-table-wrapper">
                <table class="admin-table" id="usersTable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><?php echo e($user->id ?? '1'); ?></td>
                            <td><?php echo e($user->name ?? 'Александр Иванов'); ?></td>
                            <td><?php echo e($user->email ?? 'user@example.com'); ?></td>
                            <td>
                                <span class="admin-badge <?php echo e(($user->status ?? 'user') == 'admin' ? 'badge-danger' : 'badge-info'); ?>">
                                    <?php echo e(($user->status ?? 'user') == 'admin' ? 'Администратор' : 'Пользователь'); ?>

                                </span>
                            </td>
                            <td><?php echo e($user->created_at ?? '2023-06-15'); ?></td>
                            <td class="actions">
                                <button class="admin-btn admin-btn--small edit-user-btn" data-id="<?php echo e($user->id ?? '1'); ?>">Редактировать</button>
                                <button class="admin-btn admin-btn--small admin-btn--danger delete-user-btn" data-id="<?php echo e($user->id ?? '1'); ?>">Удалить</button>
                            </td>
                        </tr>
...
<?php echo $__env->make('layouts.adm', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\OSPanel\domains\yg\resources\views/admin/users.blade.php ENDPATH**/ ?>