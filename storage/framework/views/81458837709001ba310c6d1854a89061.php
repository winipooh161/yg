...
<script>
var telegramStoreUrl = "<?php echo e(route('telegram.store')); ?>";
    ...
    questions: [
        {
            ...
            type: "radio-image",
            options: [
                { value: "apartment", text: "Квартира - новостройка", image: "<?php echo e(asset('img/quiz/apartment.jpg')); ?>" },
                { value: "cottage", text: "Квартира - вторичка", image: "<?php echo e(asset('img/quiz/cottage.jpg')); ?>" },
                { value: "office", text: "Дом, коттедж", image: "<?php echo e(asset('img/quiz/office.jpg')); ?>" },
                { value: "commercia", text: "Коммерческое помещение", image: "<?php echo e(asset('img/quiz/commercia.jpg')); ?>" }
            ]
        },
        {
...
<?php /**PATH C:\OSPanel\domains\yg\resources\views/layouts/quiz.blade.php ENDPATH**/ ?>