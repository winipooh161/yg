    ...
    <div class="admin-card wow fadeInUp">
            ...
            <table class="admin-table" id="projectsTable">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <img src="<?php echo e(asset($project->image) ?: asset('img/placeholder.jpg')); ?>" alt="<?php echo e($project->title); ?>" class="project-thumbnail">
                        </td>
                        <td><?php echo e($project->title); ?></td>
                        <td class="project-description"><?php echo e(Str::limit($project->description, 50)); ?></td>
                        <td><?php echo e($project->area); ?></td>
                        <td><?php echo e($project->time); ?></td>
                        <td><?php echo e($project->price); ?></td>
                        <td><?php echo e($project->slug); ?></td>
                        <td><?php echo e($project->created_at->format('d.m.Y')); ?></td>
                        <td class="actions">
                            <div class="btn-group">
                                <a href="<?php echo e(route('admin.projects.create')); ?>?edit=<?php echo e($project->id); ?>" class="admin-btn admin-btn--small edit-btn">Редактировать</a>
                                <button class="admin-btn admin-btn--small admin-btn--info content-view-btn" 
                                    ...
                                    data-content="<?php echo e($project->content); ?>">
                                    Просмотр
                                </button>
        ...
        <?php else: ?>
            <div class="admin-alert-info">
                Проекты не найдены. <a href="<?php echo e(route('admin.projects.create')); ?>" class="admin-link">Добавьте первый проект</a>.
            </div>
        <?php endif; ?>
    </div>
</div>
    ...
    $(document).ready(function() {
        ...
        function initModalHandlers() {
            ...
            $('.content-view-btn').off('click').on('click', function() {
                ...
                var url = "<?php echo e(route('admin.projects.gallery', ['id' => ':id'])); ?>";
...
<?php echo $__env->make('layouts.adm', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\OSPanel\domains\yg\resources\views\admin\projects.blade.php ENDPATH**/ ?>